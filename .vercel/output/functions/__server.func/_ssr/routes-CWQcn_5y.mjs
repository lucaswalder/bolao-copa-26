...
import { d as respondX1Challenge, h as useCard, i as createX1Challenge, p as saveGuess, r as cancelX1Challenge } from "./bolao-DVb7JzZB.mjs";
...
import { D as ArrowUp, E as Brain, T as CalendarDays, _ as Flag, c as ShieldCheck, f as Pencil, g as ListFilter, h as Lock, i as Swords, k as ArrowDown, l as Search, m as LogOut, n as UserPlus, p as Medal, r as Trophy, t as X, u as Save, w as Check } from "../_libs/lucide-react.mjs";
...
import { t as Route } from "./routes-DrHOibw4.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CWQcn_5y.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardHeader, {
			...
			hasResult ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
					...
					" x ",
					match.awayScore
				] }), match.oddsMultiplier && match.oddsMultiplier > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					className: `ml-2 inline-block rounded px-1.5 py-0.5 text-xs font-black ${match.oddsMultiplier >= 4 ? "bg-amber-100 text-amber-700" : "bg-zinc-100 text-zinc-600"}`,
			...
			match.guess ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-3 space-y-1",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-sm font-semibold text-[var(--sea-ink-soft)]",
						children: [
							"Seu palpite: ",
					...
					hasResult && match.oddsMultiplier && match.oddsMultiplier > 1 && match.guess.points > 2 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "text-xs font-black text-amber-600",
						children: [
							"🔥 Odds ",
							match.oddsMultiplier,
							"x — palpite raro multiplicou seus pontos!"
						]
					}) : null,
					!hasResult && match.estimatedOdds && match.estimatedOdds > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: `text-xs font-semibold ${match.estimatedOdds >= 4 ? "text-amber-600" : "text-zinc-500"}`,
						children: match.estimatedOdds >= 5 ? `🔥 Palpite único! Potencial ${match.estimatedOdds}x se acertar o placar exato` : match.estimatedOdds >= 3 ? `⚡ Palpite incomum — potencial ${match.estimatedOdds}x nas odds` : `Potencial ${match.estimatedOdds}x se acertar o placar exato`
					}) : null
				]
			}) : null,
			error ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
